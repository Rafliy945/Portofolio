  ...
  return (
    <div className={`relative w-full ${BLUR_HOVER_LINK}`}>
      ...
      <div className="mb-10 flex flex-col gap-2 md:hidden">
        <Link to="https://www.linkedin.com/in/rafli-yanto/" target="_blank" className="flex items-end gap-2">
          <GrLinkedin className="mt-1 text-xl text-primary" />
          <span className="font-poppins font-light underline">Linkedin</span>
        </Link>
        <Link to="https://github.com/Rafliy945" target="_blank" className="flex items-end gap-2">
          <GrGithub className="text-xl !text-primary" />
          <span className="font-poppins font-light underline">Github</span>
        </Link>
        <Link to="mailto:rafliy945@gmail.com" className="flex items-end gap-2">
          <MdEmail className="text-xl !text-primary" />
          <span className="font-poppins font-light underline">rafliyanto@gmail.com</span>
        </Link>
      </div>
      <StaggerSlideElementMenu
        startDelay={1.2}
        ...
        tag="div"
      >
        <Link to="https://www.linkedin.com/in/rafli-yanto/" target="_blank" className="flex items-baseline">
          <GrLinkedin className="mt-1 text-xl text-white" />
        </Link>
        <Link to="https://github.com/Rafliy945" target="_blank" className="flex items-baseline">
          <GrGithub className="text-xl !text-white" />
        </Link>
        <Link to="mailto:rafliy945@gmail.com" className="flex items-baseline">
