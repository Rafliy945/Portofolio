    ...
    <motion.section ref={containerScope} className="relative z-10 mt-[-100vh] w-screen bg-secondary">
      <div className="container relative mx-auto w-full">
        ...
        <motion.p style={{ y: scrollSpeedDesc }} className="CONTAINER MENU-CHANGE-Y-100  pointer-events-none mt-20 text-4xl text-gray-600">
          Halo, I&apos;m <span className="font-semibold text-primary">Rafli Yanto</span>, seorang{' '}
          <span className="font-semibold text-primary">Fullstack Developer</span> berpengalaman dengan lebih dari 1 tahun pengalaman. Saya mengkhususkan diri dalam menciptakan pengalaman web yang bukan sekadar halaman statis, melainkan perjalanan digital yang dinamis dan interaktif. Jelajahi dunia pengembangan web interaktif yang saya bangun.
        </motion.p>
        <AnimatePresence>
          <Magnet strength={10} className="MENU-CHANGE-Y-200 z-[-10] mt-4 w-fit">
            <motion.div
      ...
      <div className="relative z-10 h-[150vh] w-full bg-secondary">
        <div className="container mx-auto pt-[5%]">
          ...
          <motion.p className="CONTAINER MENU-CHANGE-Y-100 pointer-events-none mt-20 text-4xl text-gray-500">
            Saya bukan hanya seorang <span className="font-semibold text-primary">developer </span>. saya adalah pemecah masalah, pemikir kreatif, dan mitra dalam perjalanan digital Anda
             <span className="font-semibold text-primary"> Mari kita wujudkan ide-ide Anda </span> adan menciptakan pengalaman yang mampu berkesan serta terhubung dengan audiens Anda. Siap untuk memulai perjalanan ini bersama? Hubungi saya, dan mari kita jadikan dunia web tempat yang lebih menarik, satu proyek interaktif dalam satu waktu.
          </motion.p>
        </div>
      </div>
    </motion.section>
