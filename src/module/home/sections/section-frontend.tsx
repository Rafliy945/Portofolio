    ...
    <section className="relative z-[1000] min-h-[100vh] w-full bg-secondary pt-10">
      <div className="CONTAINER flex h-screen items-center ">
        <p className="MENU-CHANGE-Y-200 font-spartan text-6xl font-light xl:text-8xl 2xl:text-8xl 2xl:leading-loose">
          <WithCursorElement state={{ element: functionalityCursor as any }}>Fungsional</WithCursorElement> +{' '}
          <WithCursorElement state={{ element: aetheticsCursor as any }}>Aestetik</WithCursorElement> =
          <WithCursorElement state={{ element: satisfiedCursor as any }}>Kepuasan</WithCursorElement>
        </p>
      </div>
    </section>
  )
