...
const CreativeDeveloperSection = () => {
  ...
  // heartPathColor dan heartPath (untuk stroke jantung) dihapus agar tidak eror
        ...
        <div className="pointer-events-none sticky left-0 top-0">
          <div className="absolute left-0 top-0">
            <div className="MENU-CHANGE-SCALE-125 relative h-screen w-screen">
              ...
              >
                {/* Mengganti HeartPath dengan MountainParallax */}
                {/* Mengirim scrollYProgress agar efek parallax di gunung bekerja */}
                <MountainParallax progress={scrollYProgress} />
              </motion.div>
