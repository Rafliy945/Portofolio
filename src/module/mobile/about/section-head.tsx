...
export const StackedImage = () => {
  return (
    ...
    >
      <motion.img src="/me.png" alt="Rafliyanto" className="w-[80%] object-cover" />
      <motion.img src="/me.png" alt="Rafliyanto" className="absolute w-[70%] object-cover" />
      <motion.img src="/me.png" alt="Rafliyanto" className="absolute w-[60%] object-cover" />
    </motion.div>
  )
}
