  ...
  return (
    <div className="CONTAINER min-h-screen">
      ...
      <div className="flex flex-col">
        <h2 className=" MENU-CHANGE-Y-100 font-poppins text-6xl font-semibold text-white lg:text-9xl">Rafli yanto</h2>
        <p className="MENU-CHANGE-Y-200 mt-10 text-justify font-poppins text-lg text-secondary lg:text-left lg:text-xl">
          <span className="font-semibold text-white">Hi there!</span> 👋 Selamat datang di profil saya. Senang berkenalan dengan Anda! Nama saya Rafli, saya seorang Full-Stack
          DDeveloper dengan pengalaman 1 tahun membangun aplikasi web tingkat perusahaan menggunakan React, Next.js, NestJS.
          <br />
          <br />
          Let's make something beautiful with code! 🎉🎉🎉
        </p>
        <a href="Muhammad_Rafliyanto.pdf" target="_blank" download title="download cv" className="MENU-CHANGE-Y-200 mt-10 w-fit" rel="noreferrer">
          <motion.div
